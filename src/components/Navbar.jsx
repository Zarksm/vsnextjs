...
function Navbar() {
  return (
    <>
      <header className="sticky top-0 z-50 flex flex-col w-full items-center select-none notranslate bg-white shadow-lg dark:shadow-none border-primary dark:border-transparent dark:bg-primary dark:text-white py-5 anim">
